...
<body>
    ...
    <h2>GESTIONE CATALOGO</h2>
        ...
        <tr>
            <td><%= escapeHtml(bean.getNome()) %></td>
            <td><%= escapeHtml(bean.getPiattaforma()) %></td>
            <td><%= escapeHtml(String.valueOf(bean.getQuantità())) %></td>
            <td><a href="ModificaProdotto.jsp?prodotto=<%= escapeHtml(String.valueOf(bean.getIdProdotto())) %>"><button>Modifica</button></a></td>
        </tr>
